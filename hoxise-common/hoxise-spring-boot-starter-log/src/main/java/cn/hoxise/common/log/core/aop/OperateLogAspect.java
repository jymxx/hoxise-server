package cn.hoxise.common.log.core.aop;
...
import cn.hoxise.common.log.core.service.OperateLogBaseDTO;
...
/**
 * 操作日志切面
 * 目前只记录{@link Operation 注解显示标注的接口}
 *
 * @author hoxise
 * @since 2026/01/14 07:09:33
 */
@Aspect
@Slf4j
...
//    }
    ...
    private void log0(ProceedingJoinPoint joinPoint,
        ...
        // 异步记录日志
        String tokenValue = SaTokenUtil.getTokenValue();//Satoken 异步方法需要重新设置Mock
