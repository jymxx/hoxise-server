...
public class BangumiDbCharacterServiceImpl extends ServiceImpl<MovieDbBangumiCharacterMapper, BangumiDbCharacterDO>
    ...
    @Override
    public List<MovieCharactersVO> getCharacters(Long bangumiId) {
        Assert.notNull(bangumiId, "参数错误");
        //从数据库查角色信息
...
//        });
    ...
    public void removeByBangumiId(Long bangumiId) {
        this.remove(Wrappers.lambdaQuery(BangumiDbCharacterDO.class).eq(BangumiDbCharacterDO::getBangumiId, bangumiId));
    }
