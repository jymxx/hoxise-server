...
public class BangumiDbInfoboxServiceImpl extends ServiceImpl<MovieDbBangumiInfoboxMapper, BangumiDbInfoboxDO>
    ...
    public void removeByBangumiId(Long bangumiId) {
        this.remove(Wrappers.<BangumiDbInfoboxDO>lambdaQuery().eq(BangumiDbInfoboxDO::getBangumiId, bangumiId));
    }


    @Override
    public List<BangumiDbInfoboxDO> getByBangumiId(Long bangumiId) {
        return this.list(Wrappers.<BangumiDbInfoboxDO>lambdaQuery().eq(BangumiDbInfoboxDO::getBangumiId, bangumiId));
    }
