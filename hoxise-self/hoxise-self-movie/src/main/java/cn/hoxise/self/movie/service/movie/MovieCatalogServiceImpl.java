...
import cn.hoxise.self.movie.convert.MovieCatalogConvert;
import cn.hoxise.self.movie.dal.entity.*;
import cn.hoxise.self.movie.pojo.enums.MovieTypeEnum;
import cn.hoxise.self.movie.service.movie.bangumi.*;
...
import cn.hoxise.self.movie.dal.mapper.MovieCatalogMapper;
